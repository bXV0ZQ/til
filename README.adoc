...
* link:linux/retrieve-args-used-to-launch-a-process.adoc[Retrieve args used to launch a process]
* link:linux/retrieve-pid-of-a-process.adoc[Retrieve pid of a process]
